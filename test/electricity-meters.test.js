...
const connectionString = process.env.DATABASE_URL || 'postgresql://nkully:nkully@localhost:5432/topups';
...
describe("The Electricity meter", function() {
    ...
    it("should see all the appliances", async function() {
        ...
        const electricityMeters = ElectricityMeters(pool);
        const appliances = await electricityMeters.streetMeters();

        assert.deepStrictEqual([], streetMeters);
